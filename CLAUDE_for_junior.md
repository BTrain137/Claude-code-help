...
## Who I Am
I am a junior developer learning full-stack development. I need to understand everything before I ship it.
...
### Commit Messages
1. Keep them short and conventional (feat:, fix:, docs:)
2. NEVER add "Co-Authored-By" or any AI attribution
3. NEVER add long AI-generated descriptions
4. The commit message is MY message, not yours
